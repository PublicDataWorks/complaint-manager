...
export const DATA_SECTIONS = {
  ...
  [DDS_COMPLAINTS_OVER_TIME]: {
    ...
    collapsedText: `With this chart, the ${ORGANIZATION} seeks to capture if there are any patterns around complainants and complaint types during the year. This table tracks the type of complainant who filed a complaint referral with the ${ORGANIZATION} within a given time period`,
    fullMessage: `With this chart, the ${ORGANIZATION} seeks to capture if there are any patterns around complainants and complaint types during the year. This table tracks the type of complainant who filed a complaint referral with the ${ORGANIZATION} within a given time period.\n\nWith this chart, the ${ORGANIZATION} seeks to capture if there are any patterns around complainants and complaint types during the year.  For example, there was a peak of complaints from the community – Civilian Complaints – in June during the interactions that occurred around the protests of police misconduct and the protest on the Crescent City Connection bridge.  ${ORGANIZATION} tracks to see if there are other concentrations of complainants or complaint types during other points of the year including festival season, Mardi Gras, Essence, Voodoo Festival, hurricane season, sporting events, and the holidays.`,
    orderKey: 2
  },
  [DDS_COMPLAINANTS_SUBMIT_COMPLAINTS]: {
