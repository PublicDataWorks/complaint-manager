...
export const GET_RULE_CHAPTERS_SUCCESS = "GET_RULE_CHAPTERS_SUCCESS";
export const GET_DIRECTIVES_SUCCESS = "GET_DIRECTIVES_SUCCESS";
...
export const GET_PRIORITY_LEVEL_SUCCEEDED = "GET_PRIORITY_LEVEL_SUCCEEDED";
export const GET_PRIORITY_REASONS_SUCCEEDED = "GET_PRIORITY_REASONS_SUCCEEDED";
...
export const GET_HOUSING_UNITS_SUCCEEDED = "GET_HOUSING_UNITS_SUCCEEDED";
