...
describe("test provide_audit_details_for_data_access_audits_when_accessing_case_notes", () => {
  ...
  describe("provideAuditDetailsForDataAccessAuditsWhenAccessingCaseNotes", () => {
    ...
    test("should update case note audit details when not following a data change before case note actions", async () => {
      const caseNoteAccessAudit = await models.action_audit.create({
        action: AUDIT_ACTION.DATA_ACCESSED,
        auditType: AUDIT_TYPE.DATA_ACCESS,
        user: testuser,
    ...
    test("should update case note audit details when not following a data change after case note actions", async () => {
      const caseNoteAccessAudit = await models.action_audit.create({
        action: AUDIT_ACTION.DATA_ACCESSED,
        auditType: AUDIT_TYPE.DATA_ACCESS,
        user: testuser,
