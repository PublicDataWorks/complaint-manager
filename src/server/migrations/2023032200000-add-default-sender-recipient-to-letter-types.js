const ADD_COLUMNS_QUERY = `ALTER TABLE letter_types
  ADD default_recipient TEXT,
  ADD default_recipient_address TEXT`;

const DROP_COLUMNS_QUERY = `ALTER TABLE letter_types
  DROP COLUMN default_recipient,
  DROP COLUMN default_recipient_address`;
