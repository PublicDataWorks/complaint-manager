...
const collationQuery =
  'alter table tags alter column name type varchar(255) collate "C";';
const reverseCollationQuery =
  "alter table tags alter column name type varchar(255);";
  ...
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      await queryInterface.sequelize.transaction(async transaction => {
        ...
        await queryInterface.sequelize.query(`DROP VIEW IF EXISTS ${viewName2}`)
      ...
      throw new Error(
        `Error while updating collation of tag name field. Internal Error: ${error}`
      );
    }
  },
