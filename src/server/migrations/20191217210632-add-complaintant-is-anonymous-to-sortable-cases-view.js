...
const sortableCasesViewWithoutComplainantIsAnonymous = `CREATE VIEW sortable_cases_view AS
          (SELECT id,
                 complaint_type,
                 case_number,
                 YEAR,
        ...
        await queryInterface.sequelize
          ...
          .then(async () => {
            await queryInterface.sequelize.query(
              sortableCasesViewWithComplainantIsAnonymous,
              {
                transaction
              }
            );
    ...
    try {
      await queryInterface.sequelize.transaction(async transaction => {
        await queryInterface.sequelize
          ...
          .then(async () => {
            await queryInterface.sequelize.query(
              sortableCasesViewWithoutComplainantIsAnonymous,
              {
                transaction
              }
            );
