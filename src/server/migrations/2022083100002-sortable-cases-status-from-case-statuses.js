...
SELECT cases.id,
   ...
   FROM ((((cases
   	 LEFT JOIN case_statuses case_status ON cases.current_status = case_status.id
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    try {
      ...
      throw new Error(
        `Error while updating sortable cases view. Internal Error: ${error}`
      );
    }
  },
  ...
  down: async (queryInterface, Sequelize) => {
    try {
      ...
      throw new Error(
        `Error while reverting changes to sortable cases view. Internal Error: ${error}`
      );
    }
  }
};
