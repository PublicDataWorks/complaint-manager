...
describe("exportCasesQuery", () => {
  test("does not include deleted items", () => {
    ...
    const expectedExtraJoinFromCount = 6;
    ...
    // (1) string_agg function uses the word from
    // (6) there are two joins on sub queries that already check for deleted in the sub queries
