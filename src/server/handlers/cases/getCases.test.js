...
describe('getCases', () => {
    ...
    describe('GET /cases', () => {
        ...
        beforeEach(async () => {
            const civilian = new Civilian.Builder().defaultCivilian()
                .withId(undefined)
                .withNoAddress()
            ...
            officer = new Officer.Builder().defaultOfficer()
                .withFirstName('Jeff')
                .withId(undefined)
                .build()

            const accusedOfficer = new CaseOfficer.Builder().defaultCaseOfficer()
                .withCaseId(undefined)
                .withId(undefined)
                .withOfficer(officer)
                .build()

            const defaultCase = new Case.Builder().defaultCase()
                .withId(undefined)
