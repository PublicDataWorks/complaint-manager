...
describe("csvCaseExport request", () => {
  ...
  describe("with case data", () => {
    ...
    test("should retrieve civilian complainant + officer complainant data", async () => {
      ...
      expect(
        officerComplainantRow["Officer Complainant Employee ID"]
      ...
      expect(
        officerComplainantRow["Officer Complainant Supervisor Employee ID"]
    ...
    test("should include data about officer", async () => {
      ...
      expect(
        firstRecord["Accused Officer Supervisor Employee ID"]
