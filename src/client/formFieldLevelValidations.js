...
export const priorityLevelIsRequired = isRequired("Priority Level");
export const priorityReasonIsRequired = isRequired("Priority Reason");
...
export const OneFormOfContactRequired = isRequired("one Form of Contact");
