...
const RemoveUserActionDialog = ({dialogOpen, caseId, userActionId, dispatch}) => {
    ...
    return (
        <Dialog open={dialogOpen}>
            ...
            <DialogContent>
                <Typography>
                    This action will remove this note and its information. Are you sure you want to continue?
                </Typography>
            </DialogContent>
            <DialogActions>
                <CancelButton
