...
jest.mock('../thunks/updateNarrative', () => jest.fn(() => ({
...
describe('narrative', () => {
    ...
    test('should have initial values', () => {
        containsText(narrative, '[data-test="narrativeDetailsInput"]', expectedCase.narrativeDetails)
        containsText(narrative, '[data-test="narrativeSummaryInput"]', expectedCase.narrativeSummary)
    })
    ...
    test('should update case narrative when save button is clicked', () => {
        ...
        changeInput(narrative, 'textarea[data-test="narrativeDetailsInput"]', updateDetails.narrativeDetails)
        changeInput(narrative, 'textarea[data-test="narrativeSummaryInput"]', updateDetails.narrativeSummary)
