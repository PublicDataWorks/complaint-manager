...
test('it can sort mixed complainant officers', () => {
    ...
    const civilianComplainantThree = new Civilian.Builder().defaultCivilian()
        .withFirstName('Bravo')
        .withLastName('Alpha')
        .build()


    const civilianComplainantTwo = new Civilian.Builder().defaultCivilian()
        .withLastName('Zorph')
        .build()
    ...
    const caseOfficerUnknown = new CaseOfficer.Builder().defaultCaseOfficer()
        .withRoleOnCase("Witness")
        .withOfficer({ fullName: 'Unknown Officer'})
        .build()

    const caseWithMixedComplainants = new Case.Builder().defaultCase()
        .withCivilians([civilianComplainantTwo, civilianComplainant, civilianComplainantThree])
        .withComplainantWitnessOfficers([caseOfficerUnknown, caseOfficer])
        .build()


    const expected = [caseOfficerUnknown, civilianComplainantThree, civilianComplainant, caseOfficer, civilianComplainantTwo]
