...
const CaseDrawer = ({classes, caseDetail}) => (
    ...
    >
        <div>
            ...
            <Typography data-test="case-number" variant="title" style={{marginLeft: "24px", marginTop: '4px'}}
                        gutterBottom>
                {`Case #${caseDetail.id}`}
            </Typography>
            <div className={classes.drawerRow}>
                <div className={classes.drawerRowItem}>
                    ...
                    <Typography data-test="created-by"
                                variant='body1'>{caseDetail.createdBy}</Typography>
                </div>
                <div className={classes.drawerRowItem}>
            ...
            <div className={classes.drawerRowEnd}>
                <div className={classes.drawerRowItem}>
                    ...
                    <Typography data-test="assigned-to"
                                variant='body1'>{caseDetail.assignedTo}</Typography>
                </div>
                <div className={classes.drawerRowItem}/>
                <div className={classes.drawerRowItem}/>
            </div>
