...
const scenarios = [
  { role: "Complainant", addButtonIndex: 0 },
  { role: "Witness", addButtonIndex: 1 }
];

scenarios.forEach(({ role, addButtonIndex }) => {
  pactWith(
    {
    ...
    provider => {
      ...
      describe(`add/edit civilian ${role}`, () => {
        ...
        test(`should add a civiliant ${role}`, async () => {
          const civilian = {
          ...
          await provider.addInteraction({
            ...
            willRespondWith: {
              ...
              body: like({
                ...
                complainantCivilians: role === "Complainant" ? [civilian] : [],
          ...
          userEvent.click(addButtons[addButtonIndex]);
